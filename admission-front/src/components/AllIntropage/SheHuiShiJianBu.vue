  ...
  <div>
    ...
    <el-button icon="el-icon-back" v-on:click="handleCard('AllDepintro')"></el-button>
      <el-card :body-style="{ padding: '0px' }"  class="card" >
        ...
        <p>More Messages --<a href="http://mp.weixin.qq.com/s?__biz=MzA5Mjk1OTM2OA==&mid=2652256166&idx=1&sn=f28ff4b4b06b43154dd00bf23c440205&chksm=8b87b041bcf0395714c9649636944ea86fff5d726e21af3a3618f8a031cdec56b02bb100e495&mpshare=1&scene=23&srcid=0829C5Oddmw2zt2kcMVccn6v#rd" 
          target="_blank" >社会实践部部门介绍</a></p>
      </el-card>
